#ifndef CORE_INC_GT911_STRUCTS_H_
#define CORE_INC_GT911_STRUCTS_H_
...
typedef struct
{
  ...
  uint8_t NC_4[2];
  // 0x8082
  GTFreqHoppingConfig_t hoppingSegments[5];
  // 0x8091
  uint8_t NC_5[2];
  GTKeyConfig_t keys;
...
#endif /* CORE_INC_GT911_STRUCTS_H_ */
